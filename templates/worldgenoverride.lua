...
return {
	...
	overrides = {
		--WORLDSETTINGS
		-- GLOBAL
		specialevent = "default", 			-- "none", "default", "crow_carnival", "hallowed_nights", "winters_feast", "year_of_the_gobbler", "year_of_the_varg", "year_of_the_pig", "year_of_the_carrat", "year_of_the_beefalo"
		...
		-- RESOURCES
		regrowth = "fast", 			-- "never", "veryslow", "slow", "default", "fast", "veryfast"
		deciduoustree_regrowth = "fast", 			-- "never", "veryslow", "slow", "default", "fast", "veryfast"
		carrots_regrowth = "fast", 			-- "never", "veryslow", "slow", "default", "fast", "veryfast"
		evergreen_regrowth = "fast", 			-- "never", "veryslow", "slow", "default", "fast", "veryfast"
		flowers_regrowth = "fast", 			-- "never", "veryslow", "slow", "default", "fast", "veryfast"
		...
		rabbits_setting = "often", 			-- "never", "rare", "default", "often", "always"
		...
		berrybush = "often", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		...
		carrot = "mostly", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		...
		grass = "mostly", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		...
		sapling = "often", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		...
		trees = "mostly", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		...
		beefalo = "often", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		...
		rabbits = "often", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		...
		spiders = "often", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		cave_spiders = "default", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		tallbirds = "often", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
